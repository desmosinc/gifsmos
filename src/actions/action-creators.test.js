...
describe('Action creators', () => {
  ...
  describe('async action creators', () => {
    ...
    xit('return an action to temporarily display error message', () => {
      jest.useFakeTimers();
    ...
    xit('return an action to request a frame from the calculator', () => {
      const expectedActions = [
        {
          type: types.ADD_FRAME,
    ...
    xit('return an action to request a burst of frames from the calculator', () => {
      const opts = {
        height: 300,
        idx: 1,
        max: 3,
    ...
    xit('return actions to play animation via frames in state', () => {
      const expectedActions = [
    ...
    xit('return action to generate a GIF via frames in state', () => {
      const expectedActions = [
